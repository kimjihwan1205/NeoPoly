        ...
        {activeTab === 'profile' ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] gap-x-10 gap-y-8 border-b border-[#1F2329] pb-8 mb-8">
            <div className="flex flex-col gap-4">
              ...
              <span className="text-[14px] text-neutral-400 font-medium">권장 사이즈 512x512, JPG 또는 PNG (최대 10MB)</span>
            </div>
            ...
            <div className="flex flex-col gap-4 min-w-0">
              ...
              <span className="text-[14px] text-neutral-400 font-medium">권장 사이즈 1920x480, JPG 또는 PNG (최대 10MB)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8 pb-8 border-b border-[#1F2329]">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-2.5">
                  <label className="text-[14px] font-medium text-neutral-300">전문 분야 (최대 5개)</label>
                  <div className="w-full bg-[#050505] border border-[#1F2329] hover:border-[#2A2E36] transition-colors rounded-lg p-3 min-h-[90px] flex flex-wrap content-start gap-2 relative">
                    <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[#141518] border border-[#1F2329] rounded-md text-[14px] font-medium text-neutral-300">Character <X className="w-3.5 h-3.5 text-neutral-400 cursor-pointer hover:text-white" /></div>
                    <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[#141518] border border-[#1F2329] rounded-md text-[14px] font-medium text-neutral-300">Fantasy <X className="w-3.5 h-3.5 text-neutral-400 cursor-pointer hover:text-white" /></div>
                    <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[#141518] border border-[#1F2329] rounded-md text-[14px] font-medium text-neutral-300">Game Asset <X className="w-3.5 h-3.5 text-neutral-400 cursor-pointer hover:text-white" /></div>
                    <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[#141518] border border-[#1F2329] rounded-md text-[14px] font-medium text-neutral-300">Environment <X className="w-3.5 h-3.5 text-neutral-400 cursor-pointer hover:text-white" /></div>
                    <ChevronDown className="absolute right-4 top-4 w-4 h-4 text-neutral-400 cursor-pointer hover:text-white transition-colors" />
                  </div>
                </div>

                <div className="space-y-2.5">
                  <label className="text-[14px] font-medium text-neutral-300">사용 툴 (최대 6개)</label>
                  <div className="w-full bg-[#050505] border border-[#1F2329] hover:border-[#2A2E36] transition-colors rounded-lg p-3 min-h-[110px] flex flex-wrap content-start gap-2 relative">
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-[#141518] border border-[#1F2329] rounded-md text-[14px] font-medium text-neutral-300">
                      <div className="h-7 min-w-7 px-1 rounded text-[14px] flex items-center justify-center font-medium bg-[#333] text-white">Z</div> ZBrush
                    </div>
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-[#141518] border border-[#1F2329] rounded-md text-[14px] font-medium text-neutral-300">
                      <div className="h-7 min-w-7 px-1 rounded text-[14px] flex items-center justify-center font-medium bg-[#E87D0D] text-white">B</div> Blender
                    </div>
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-[#141518] border border-[#1F2329] rounded-md text-[14px] font-medium text-neutral-300">
                      <div className="h-7 min-w-7 px-1 rounded text-[14px] flex items-center justify-center font-medium bg-[#0D8E9E] text-white">M</div> Maya
                    </div>
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-[#141518] border border-[#1F2329] rounded-md text-[14px] font-medium text-neutral-300">
                      <div className="h-7 min-w-7 px-1 rounded text-[14px] flex items-center justify-center font-medium bg-[#7BB12F] text-white">S3</div> Substance 3D
                    </div>
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-[#141518] border border-[#1F2329] rounded-md text-[14px] font-medium text-neutral-300">
                      <div className="h-7 min-w-7 px-1 rounded text-[14px] flex items-center justify-center font-medium bg-[#31A8FF] text-[#050505]">Ps</div> Photoshop
                    </div>
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-[#141518] border border-[#1F2329] rounded-md text-[14px] font-medium text-neutral-300">
                      <div className="h-7 min-w-7 px-1 rounded text-[14px] flex items-center justify-center font-medium bg-[#fff] text-[#050505]">U</div> Unreal Engine
                    </div>
          ...
          {/* 외부 링크 */}
          <div className="space-y-5">
            <h3 className="text-[17px] font-semibold text-neutral-100">외부 링크</h3>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-4">
              <div className="flex items-center gap-4">
                <span className="w-[70px] text-[14px] font-medium text-neutral-400 shrink-0">ArtStation</span>
              ...
              <div className="flex items-center gap-4">
                <span className="w-[70px] text-[14px] font-medium text-neutral-400 shrink-0">Website</span>
                <div className="flex-1 relative">
              ...
              <div className="flex items-center gap-4">
                <span className="w-[70px] text-[14px] font-medium text-neutral-400 shrink-0">Instagram</span>
                <div className="flex-1 relative">
              ...
              <div className="flex items-center gap-4">
                <span className="w-[70px] text-[14px] font-medium text-neutral-400 shrink-0">Twitter</span>
                <div className="flex-1 relative">
