  ...
  return (
    <div className="absolute inset-0 z-[100] flex bg-[#050505]/60 backdrop-blur-sm text-white font-sans antialiased items-center justify-center overflow-hidden">
      ...
      <div className="max-w-5xl w-full px-8 flex flex-col items-center relative z-10">
        ...
        <div className="mb-6 inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#E0A12E]/30 bg-[#E0A12E]/10 text-[#E0A12E] text-[13px] font-bold tracking-wide shadow-[0_0_15px_rgba(224,161,46,0.15)]">
          <Sparkles className="w-4 h-4" /> NeoPoly AI Studio
        </div>
        
        <h1 className="text-[42px] leading-[1.3] font-bold mb-6 text-center text-[#F5F5F5]">
          가장 완벽한 <span className="text-[#E0A12E]">풀 워크플로우</span> 경험
        </h1>
        
        <p className="text-neutral-400 text-[16px] text-center max-w-2xl mb-16 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-16 px-4">
          {/* Step 1 */}
          <div className="bg-[#0A0B0D] border border-[#1F2329] rounded-[24px] p-8 relative overflow-hidden transition-all duration-300">
            ...
            <h3 className="text-[20px] font-bold mb-4 relative z-10 text-[#F5F5F5]">프롬프트 구체화</h3>
            <p className="text-neutral-400 text-[14px] leading-relaxed relative z-10">
          ...
          <div className="bg-[#0A0B0D] border border-[#1F2329] rounded-[24px] p-8 relative overflow-hidden transition-all duration-300">
            ...
            <h3 className="text-[20px] font-bold mb-4 relative z-10 text-[#F5F5F5]">2D 레퍼런스 생성</h3>
            <p className="text-neutral-400 text-[14px] leading-relaxed relative z-10">
          ...
          <div className="bg-[#0A0B0D] border border-[#1F2329] rounded-[24px] p-8 relative overflow-hidden transition-all duration-300">
            ...
            <h3 className="text-[20px] font-bold mb-4 relative z-10 text-[#F5F5F5]">3D 모델 변환</h3>
            <p className="text-neutral-400 text-[14px] leading-relaxed relative z-10">
        ...
        <div className="flex items-center gap-6 mt-2">
          <label className="flex items-center gap-2.5 text-neutral-400 hover:text-[#F5F5F5] cursor-pointer transition-colors">
            ...
            />
            <span className="text-[14.5px] select-none">다시 보지 않기</span>
          </label>
          <button 
            onClick={handleClose}
