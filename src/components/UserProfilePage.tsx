      ...
      >
        ...
        <div className="absolute top-4 right-6 md:right-14 z-10 flex items-center gap-2">
            ...
            {BANNER_PRESETS.map((preset) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-[15px] font-bold transition-all cursor-pointer ${
                    matchesPreset 
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#0e1011]/90 backdrop-blur-md border border-border-primary hover:border-brand-primary rounded-[4px] text-[15px] leading-relaxed font-bold text-text-secondary hover:text-text-primary cursor-pointer transition-all"
          >
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center md:items-end gap-6 w-full mt-12">
          ...
          <div className="group relative w-28 h-28 md:w-32 md:h-32 rounded-full border-4 border-bg-dark overflow-hidden shrink-0 shadow-2xl bg-surface-secondary">
            ...
            >
              ...
              <span className="text-[12px] font-bold text-text-primary tracking-widest uppercase">UPLOAD</span>
            </div>
            <input 
              type="file" 
              ref={avatarInputRef} 
          ...
          <div className="flex-1 text-center md:text-left space-y-2">
            <div className="flex flex-col md:flex-row md:items-center gap-2 justify-center md:justify-start">
              <h1 className="text-[12px]xl leading-snug font-bold leading-tight font-display text-text-primary tracking-tight">{userProfile.nickname}</h1>
              <span className="text-[12px] md:self-center font-sans font-extrabold tracking-wide uppercase px-2 py-0.5 bg-brand-primary/15 border border-brand-primary/45 text-brand-primary rounded-sm h-fit self-center">
                {userProfile.role}
              </span>
            </div>
            <p className="text-[12px] text-text-tertiary">@{userProfile.username} • {userProfile.email}</p>
          </div>
        </div>
      </div>

      {/* 2. Page Content & Column Split */}
      <div className="max-w-[1920px] mx-auto px-6 mt-10 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-[#141518] rounded-[10px] border border-[#2A2E36] p-6 shadow-xl space-y-6">
            <div className="flex items-center justify-between border-b border-[#2A2E36] pb-3">
              <h3 className="text-base leading-relaxed font-bold text-text-primary flex items-center gap-2">
              ...
              <button
                ...
                className={`flex items-center gap-1 text-[15px] leading-relaxed font-bold px-2.5 py-1.5 rounded transition-all cursor-pointer ${
                  isEditingBio 
            ...
            {isEditingBio ? (
              <div className="space-y-4 font-sans animate-in fade-in duration-200">
                <div className="space-y-1.5">
                  <label className="text-[12px] font-bold text-text-tertiary">닉네임</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1.5">
                  <label className="text-[12px] font-bold text-text-tertiary">크리에이터 약력 (Bio)</label>
                  <textarea
                    value={editedBio}
                ...
                <div className="space-y-1.5">
                  <label className="text-[15px] font-bold text-text-secondary uppercase">Instagram URL</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1.5">
                  <label className="text-[15px] font-bold text-text-secondary uppercase">YouTube URL</label>
                  <input
                    type="text"
              ...
              <div className="space-y-6 animate-in fade-in duration-200">
                ...
                <div className="space-y-2">
                  <span className="text-[15px] font-bold tracking-wider text-text-secondary uppercase block">크리에이터 한 줄 설명</span>
                ...
                <div className="bg-surface-secondary border border-border-soft p-4 rounded-lg space-y-4">
                  <span className="text-[15px] font-bold tracking-wider text-text-secondary uppercase block">AI Studio 클라우드 등급</span>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[15px] leading-relaxed text-brand-primary font-sans font-bold">{userProfile.credits} / 500 CC</span>
                  </div>
                ...
                <div className="space-y-3">
                  <span className="text-[15px] font-bold tracking-wider text-text-secondary uppercase block">인증 뱃지 현황</span>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="flex items-center gap-2 bg-surface-secondary/60 border border-border-soft/60 px-3 py-2.5 rounded hover:border-brand-primary/20 transition-all">
                      ...
                      <div>
                        <p className="text-[15px] leading-relaxed font-bold text-text-primary">마스터 셀러</p>
                        <p className="text-[12px] text-text-tertiary">3D 에셋 10+ 판매</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2 bg-surface-secondary/60 border border-border-soft/60 px-3 py-2.5 rounded hover:border-brand-primary/20 transition-all">
                      <Layers className="w-5 h-5 text-[#4C88D9]" />
                      <div>
                        <p className="text-[15px] leading-relaxed font-bold text-text-primary">비주얼 파이오니어</p>
                        <p className="text-[12px] text-text-tertiary">완성된 프로젝트 3+</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3 border-t border-border-primary/30 pt-4">
                  <span className="text-[15px] font-bold tracking-wider text-text-secondary uppercase block">소셜 네트워크 연동</span>
                  <div className="flex flex-col gap-2">
                    {userProfile.instagramUrl ? (
                      ...
                      <p className="text-[12px] text-text-tertiary">인스타그램이 연동되지 않았습니다.</p>
                    )}
          ...
          <div className="flex border-b border-[#2A2E36] bg-[#141518]/80 p-1.5 rounded-lg gap-2">
            {[
              ...
              <button
                ...
                className={`flex items-center justify-center gap-2 px-5 py-3 text-[14px] leading-relaxed font-bold rounded-md transition-all cursor-pointer flex-1 md:flex-initial text-center ${
                  activeTab === tab.id
              ...
              >
                ...
                <span>{tab.label}</span>
                <span className="text-[12px] font-sans px-1.5 py-0.5 rounded-full bg-white/5 font-extrabold text-text-primary/50">{tab.count}</span>
              </button>
            ))}
          </div>
              ...
              <div className="space-y-6 animate-in fade-in duration-200">
                <div className="flex items-center justify-between pb-2 border-b border-border-soft/60">
                  <div className="space-y-1">
                    <h2 className="text-[12px]l leading-snug font-bold text-text-primary tracking-tight flex items-center gap-2 font-display">
                      완료 포트폴리오 리스트 <span className="text-text-secondary font-normal text-[12.5px]">Completed Showcase</span>
                    </h2>
                    <p className="text-[12px] text-text-tertiary">상업적 배포 및 스튜디오 라이브 프로덕션에서 컴파일 완료를 검증받은 고사양 마이크로 씬입니다.</p>
                  </div>
                  <button
                    onClick={() => handleOpenProjectModal()}
                    className="flex items-center gap-1.5 px-4 py-2.5 bg-brand-primary hover:bg-brand-hover text-bg-dark text-[15px] leading-relaxed font-bold rounded-sm transition-all cursor-pointer border-0 shadow-lg"
                  >
                ...
                {userProfile.completedProjects.length === 0 ? (
                  <div className="min-h-[300px] bg-surface-primary/30 border border-dashed border-border-primary rounded-[10px] flex flex-col items-center justify-center text-center p-8">
                    ...
                    <p className="text-[15px] leading-relaxed font-semibold text-text-primary">등록된 완료 프로젝트가 없습니다.</p>
                    <p className="text-[12px] text-text-tertiary mt-1">상단의 "새 프로젝트 등록" 버튼을 눌러 당신의 3D 마일스톤 성과를 박제해 보세요!</p>
                  </div>
                ) : (
                    ...
                    {userProfile.completedProjects.map((project) => (
                      ...
                      >
                        ...
                        <div className="aspect-[16/10] bg-bg-secondary relative overflow-hidden flex-shrink-0 border-b border-border-soft/30">
                          {projectToDelete === project.id && (
                            <div className="absolute inset-0 bg-black/80 backdrop-blur-sm z-30 flex flex-col items-center justify-center p-4 text-center">
                              ...
                              <p className="text-[15px] leading-relaxed font-bold text-text-primary mb-4">정말 이 프로젝트를 삭제하시겠습니까?</p>
                              <div className="flex gap-2">
                                <button
                                  onClick={() => setProjectToDelete(null)}
                                  className="px-3 py-1.5 bg-[#1C1E22] hover:bg-[#2A2E36] text-[15px] font-bold rounded text-text-primary transition-all border-0 cursor-pointer"
                                >
                                  취소
                                </button>
                                <button
                                  onClick={() => handleDeleteProject(project.id)}
                                  className="px-3 py-1.5 bg-red-500 hover:bg-red-600 text-[15px] font-bold rounded text-text-primary transition-all border-0 cursor-pointer"
                                >
                                  삭제하기
                                </button>
                              </div>
                          ...
                          <div className="absolute top-2.5 right-2.5 flex items-center gap-1.5 bg-[#0e1011]/80 backdrop-blur-md px-2.5 py-1 rounded border border-border-primary/55">
                            ...
                            <span className="text-[12px] font-sans font-bold text-emerald-400 uppercase tracking-widest">{project.status}</span>
                          </div>
                        </div>
                        ...
                        <div className="p-5 flex-1 flex flex-col justify-between gap-4">
                          <div className="space-y-2">
                            <div className="flex items-center justify-between">
                              <h4 className="text-base leading-relaxed font-bold text-text-primary tracking-tight group-hover:text-brand-primary transition-colors line-clamp-1">{project.title}</h4>
                              <span className="text-[12px] font-sans text-text-tertiary shrink-0">{project.completedAt}</span>
                            </div>
                            <p className="text-[12.5px] leading-relaxed text-text-tertiary line-clamp-2">{project.description || '작성된 세부 설명이 없습니다.'}</p>
                          </div>
                          ...
                          <div className="space-y-2.5 pt-3 border-t border-border-soft/20">
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              {project.tags.map((tag) => (
                                <span key={tag} className="text-[12px] font-bold tracking-tight uppercase px-2 py-0.5 bg-[#1B1D22] border border-border-soft text-text-secondary rounded">
                                  {tag}
                                </span>
                              ))}
                            </div>
                            ...
                            <div className="flex items-center justify-between pt-1">
                              ...
                              <div className="flex items-center gap-2 flex-1 mr-4">
                                <span className="text-[12px] font-sans text-text-secondary font-bold shrink-0">진척도: {project.progress}%</span>
                              ...
                              <div className="flex gap-1.5 shrink-0">
                                <button
                                  ...
                                  className="p-1 px-2.5 rounded bg-[#1C1E22] border border-border-primary hover:border-brand-primary text-brand-primary text-[15px] font-bold cursor-pointer transition-all"
                                  title="프로젝트 세부 속성 수정"
                                >
                                  수정
                                </button>
            ...
            {activeTab === 'assets' && (
              <div className="space-y-6 animate-in fade-in duration-200">
                <div className="flex items-center justify-between pb-2 border-b border-border-soft/60">
                  <div className="space-y-1">
                    <h2 className="text-[12px]l leading-snug font-bold text-text-primary tracking-tight flex items-center gap-2 font-display">
                      내 등록 에셋 리스트 <span className="text-text-secondary font-normal text-[12.5px] font-sans">Registered Portfolio</span>
                    </h2>
                    <p className="text-[12px] text-text-tertiary">스튜디오 및 메인 Discover 서칭 허브에 실시간으로 배포 연동된 나만의 3D 그래픽 파일 카탈로그입니다.</p>
                  </div>
                  <button
                ...
                {userUploadedAssets.length === 0 ? (
                  <div className="min-h-[300px] bg-surface-primary/30 border border-dashed border-border-primary rounded-[10px] flex flex-col items-center justify-center text-center p-8">
                    ...
                    <p className="text-[15px] leading-relaxed font-semibold text-text-primary">업로드 보증된 등록 에셋이 없습니다.</p>
                    <p className="text-[12px] text-text-tertiary mt-1">"새 에셋 올리기" 버튼을 통해 메인 Discover 마켓에 배포할 멋진 그래픽 리소스를 등록해 보세요!</p>
                  </div>
                ) : (
                      ...
                      return (
                        <div key={asset.id} className="group relative rounded-[6px] overflow-hidden bg-surface-primary border border-border-soft shadow-xl cursor-pointer flex flex-col aspect-[16/10]">
                          <div className="relative flex-1 overflow-hidden">
                            ...
                            <div className={`absolute top-2 right-2 w-6 h-6 rounded-[6px] flex items-center justify-center text-[12px] font-extrabold backdrop-blur-[8px] z-20 ${
                            ...
                            <div className="absolute inset-x-0 bottom-0 h-[80%] bg-gradient-to-t from-black/95 via-black/40 to-transparent flex flex-col justify-end p-3 opacity-0 group-hover:opacity-100 translate-y-1.5 group-hover:translate-y-0 transition-all duration-[300ms] ease-out z-10">
                              <h3 className="text-[15px] font-semibold text-text-primary line-clamp-2 leading-tight mb-1">{asset.title}</h3>
            ...
            {activeTab === 'favorites' && (
              <div className="space-y-6 animate-in fade-in duration-200">
                <div className="pb-2 border-b border-border-soft/60 space-y-1">
                  <h2 className="text-[12px]l leading-snug font-bold text-text-primary tracking-tight flex items-center gap-2 font-display">
                    관심 등록 보관소 <span className="text-text-secondary font-normal text-[12.5px]">Curated Favorites</span>
                  </h2>
                  <p className="text-[12px] text-text-tertiary">피드 레이아웃 카탈로그에서 하트(관심)를 누르신 에셋 리스트입니다. 실시간 렌더 스펙을 보관합니다.</p>
                </div>

                {favoriteAssets.length === 0 ? (
                  <div className="min-h-[300px] bg-surface-primary/30 border border-dashed border-border-primary rounded-[10px] flex flex-col items-center justify-center text-center p-8">
                    <Heart className="w-12 h-12 text-text-tertiary opacity-30 animate-pulse mb-3" />
                    <p className="text-[15px] leading-relaxed font-semibold text-text-primary">보관된 관심 에셋이 없습니다.</p>
                    <p className="text-[12px] text-text-tertiary mt-1">메인 마켓 플레이스의 피드 에셋 프리뷰 하트 아이콘을 클릭하시면 이 보관소에 자동으로 영구 보관됩니다.</p>
                  </div>
                ) : (
                        ...
                        <div key={asset.id} className="group relative rounded-[6px] overflow-hidden bg-surface-primary border border-border-soft shadow-xl flex flex-col aspect-[16/10]">
                          <div className="relative flex-1 overflow-hidden">
                            ...
                            <div className="absolute inset-x-0 bottom-0 h-[80%] bg-gradient-to-t from-black/95 via-black/40 to-transparent flex flex-col justify-end p-3 z-10">
                              <h3 className="text-[15px] font-semibold text-text-primary line-clamp-1 leading-tight mb-1">{asset.title}</h3>
                              <p className="text-[12px] text-text-secondary truncate">by {asset.author}</p>
                              <div className="flex items-center gap-2.5 text-[12px] text-text-secondary mt-1.5">
          ...
          <div className="fixed inset-0 bg-black/85 backdrop-blur-md z-[100] flex items-center justify-center p-4Dialog font-sans">
            ...
            >
              <div className="flex items-center justify-between px-6 py-4.5 border-b border-border-primary bg-bg-secondary">
                <h3 className="text-lg leading-relaxed font-bold text-text-primary tracking-tight flex items-center gap-2">
              ...
              <form onSubmit={handleSaveProject} className="p-6 space-y-4 font-sans">
                {/* Title */}
                <div className="space-y-1.5">
                  <label className="text-[15px] leading-relaxed font-bold text-text-tertiary">프로젝트 명칭</label>
                  <input
                    type="text"
                    required
                    value={projectTitle}
                ...
                {/* Description */}
                <div className="space-y-1.5">
                  <label className="text-[15px] leading-relaxed font-bold text-text-tertiary">세부 설명</label>
                  <textarea
                    required
                    rows={3}
                    value={projectDesc}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-[15px] leading-relaxed font-bold text-text-tertiary">상태 (Status)</label>
                    <select
                      value={projectStatus}
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[15px] leading-relaxed font-bold text-text-tertiary">진척도 (Progress): {projectProgress}%</label>
                    <input
                      type="range"
                      min="0"
                      max="100"
                ...
                {/* Tags manager */}
                <div className="space-y-2">
                  <label className="text-[15px] leading-relaxed font-bold text-text-tertiary">기술 스택 또는 태그</label>
                  <div className="flex gap-2">
                    <input
                      type="text"
                      value={newTag}
                    ...
                    <button
                      ...
                      className="px-3 bg-[#1C1E22] hover:bg-brand-primary hover:text-bg-dark border border-border-primary rounded-[6px] text-[15px] leading-relaxed font-bold transition-colors cursor-pointer"
                    >
                      추가
                    </button>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-1.5 min-h-[30px] pt-1">
                    {projectTags.map((t) => (
                      <span key={t} className="flex items-center gap-1.5 px-2 bg-brand-primary/10 border border-brand-primary/20 text-brand-primary rounded text-[15px] font-bold">
                        <span>{t}</span>
                        <button
                          type="button"
                          onClick={() => handleRemoveTag(t)}
                          className="hover:text-red-400 p-0 text-brand-primary hover:bg-transparent border-0 cursor-pointer text-[12px]"
                        >
                          <X className="w-3 h-3" />
                        </button>
                      </span>
                ...
                {/* Artwork selection */}
                <div className="space-y-2">
                  <label className="text-[15px] leading-relaxed font-bold text-text-tertiary">프로젝트 대표 이미지 업로드 / 무작위 매칭</label>
                  <div className="flex gap-4">
                    ...
                    >
                      ...
                      <span className="text-[12px] text-text-secondary">PC 불러오기</span>
                    </button>
                    <input
                      type="file"
                    ...
                    <div className="flex-1 flex flex-col gap-1">
                      <span className="text-[12px] text-text-tertiary font-bold">크리에이터 데모 작품 프리셋 중 빠른 선정:</span>
                  ...
                  <div className="aspect-[16/6] bg-bg-secondary rounded-[6px] overflow-hidden border border-border-soft flex items-center justify-center relative mt-2">
                    ...
                    <span className="absolute bottom-2 left-2 bg-black/60 backdrop-blur-sm text-[12px] px-2 py-0.5 rounded font-sans border border-white/5 font-semibold">선정된 이미지 라이브 프리뷰</span>
                  </div>
                </div>
                ...
                <div className="flex gap-3 pt-4 border-t border-border-primary/40">
                  <button
                    type="button"
                    onClick={() => setIsProjectModalOpen(false)}
                    className="flex-1 py-3 bg-[#1C1E22] hover:bg-[#25282e] text-text-secondary hover:text-text-primary rounded-[6px] text-[15px] leading-relaxed font-bold transition-all cursor-pointer border-0 text-center"
                  >
                    닫기
                  </button>
                  <button
                    type="submit"
                    className="flex-1 py-3 bg-brand-primary hover:bg-brand-hover text-bg-dark rounded-[6px] text-[15px] leading-relaxed font-bold transition-all cursor-pointer border-0 text-center shadow-lg"
                  >
